...
Our library standard must define fields that will be present in **all QR codes** generated with our library. Those fields describe the base schema of QR codes compatible with our standards definition.
