...
After investigating past work, the best way to proceed is by posting about the new idea to the [NEM Improvement Process Telegram Group][nem-improvement-process-telegram].
...
NIP authors are responsible for collecting community feedback on both the initial idea and the NIP before submitting it for review. However, wherever possible, long open-ended discussions on public telegram groups should be avoided. Strategies to keep the discussions efficient include: setting up a different telegram group channel, having the NIP author accept private comments in the early design phases, setting up a wiki page or git repository, etc. NIP authors should use their discretion here.
...
The current NIP editor is David who can be contacted at david@nemeurope.eu or @dgarcia360.

### NIP Editor Responsibilities & Workflow

The NIP editor is in the [nem-improvement-process telegram group][nem-improvement-process-telegram], he/she will follow your NIP.
...
Authors are responsible for building consensus within the community and documenting dissenting opinions before the NIP is officially discussed by the NIP Committee. Their goal is to convince the committee that their proposal is useful and addresses pertinent problems in the components as well as interactions with already existing features. Authors can change over the life-cycle of the NIP.

#### The NIP Editor

The NIP Editor is the responsible of the smooth running of NIPs. He or she appoints the committee members, calls the meetings monthly, assigns new proposals to the members, and ensures that all of them are discussed within a short period of time.

#### The NIP Committee

The NIP Committee is an experienced group of people with knowledge of the core protocol, sdks layer, applications and libraries, responsible for the strategic direction of NEM. Members are tasked with (a) communicating with the community, (b) weighing in pros and cons of every proposal, and (c) accepting, postponing or rejecting the proposal.

Committee members should be either individuals responsible for a specific part of the NEM codebase, committers or contributors of the NEM. Exceptionally, members may also be important representatives of the community with a high technical knowledge to understand the implications of every proposal and participate into the discussions. The members are elected by the NIP Editor based on their expertise and implication in the community.
...
The NIP Editor assigns every proposal to a member of the committee, who becomes the reviewer. The main tasks of the reviewer are the following:
...
All NIP Committee members vote. They can either vote in the meeting or by casting their vote via email to the NIP Editor before the set deadline.

NIP Committee members can vote “in favor”, “against” or “abstain”.
...
Note that, when calculating the lower bound, numbers round up. Therefore for a committee of 9 members, at least 50% means at least 5 members.

The deadline to vote a proposal is decided on a case-by-case basis. The deadline will be decided by the committee members present at the last meeting and the NIP Editor, and will be made public right after the meeting.
...
[nem-improvement-process-telegram]: https://t.me/NEMImprovementProcess
[nips-issues]: https://github.com/NemProject/NIPs/issues
[nips-repository]: https://github.com/NemProject/NIPs