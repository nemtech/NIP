...
| ----------------- | ------------- | ------------- |
| data*   | The transaction [serialized in hexadecimal](https://nemtech.github.io/api.html#serialization) form (recommended). Alternative, it can be [formatted as DTO](https://github.com/nemtech/nem2-sdk-java/blob/450676210c5a75f4624fc3bee7bbde96740109d1/src/main/java/io/nem/sdk/infrastructure/TransactionMapping.java) (beta).| A700...4000000 |
| chainId | The chain identifier. Popular network identifiers will be defined in a new NIP. | nem-public-chain|
