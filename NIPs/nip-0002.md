...
This approach looks more usable and less error-prone, but it not complete. Alice must use two different devices to announce transactions, one of them necessarily a mobile phone.
