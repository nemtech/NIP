...
| #sig-client | Migration tools suite to be defined | :stop_sign: | **NO** |
...
| **IR-6** | _Catapult upgrade technical definition_ | @evias| ![Progress](http://progressed.io/bar/50) |
