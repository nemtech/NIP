...
The links of the repositories moved to the new organization are automatically redirected to the new location for an unknown amount of time (except for GitHub pages).
