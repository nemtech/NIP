...
| network_id | string   | Define network : TEST_NET \| MAIN_NET \| MIJIN \| MIJIN_TEST  |
| type | integer   | 1 = [TransferTransaction](https://nemtech.github.io/concepts/transfer-transaction.html#id1) \| 2 =[AggregateTransaction](https://nemtech.github.io/concepts/aggregate-transaction.html#id1)  \| 3 = [CosignatureTransaction](https://nemtech.github.io/concepts/aggregate-transaction.html#cosignature-transaction)   |
| data      | object   | dataset                                 |
...
we may able to append many inner transactions, it depends on the transaction content. Example below:

### Default ACT QR define **(65 characters)**

`{"schema":2,"network_id":"MIJIN_TEST","type":2,"data":{"ACT":[]}}`

### One asset attached **(135 characters)**

`{"recipient":"SBWL3G4OZCABJ55EDANQBQMDOZDL2RXFATR5OLCE","assets":[{"id":"[3646934825, 3576016193]","relativeQuantity":1}],"message":{}}`

### Show Message attaced **(112 characters)**

`{"recipient":"SBWL3G4OZCABJ55EDANQBQMDOZDL2RXFATR5OLCE","assets":[],"message":{"type":1,"payload":"my message"}}`

### Normal tx **(166 characters)**

`{"recipient":"SBWL3G4OZCABJ55EDANQBQMDOZDL2RXFATR5OLCE","assets":[{"id":"[3646934825, 3576016193]","relativeQuantity":1}],"message":{"type":1,"payload":"my message"}}`

Total characters in normal transaction : Default ACT QR define (65) + normal Tx (166) = ***231 characters***
