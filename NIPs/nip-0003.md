# NIP 3 - QR Library Standard Definition
...
```
    ...
    Author: Anthony Law <anthony@nem.foundation>
            David Garcia <david@nem.foundation>
...
This section describes the **specification** of our QR code library Standard. QR codes that are to be generated with client implementations of the Catapult network _can_ use this specification as a reference to be NIP-3 compatible.
...
Following table lists mandatory fields for Catapult QR Codes compatible with NIP-3:
...
| **field** | **type** | **values** | **description** |
| :-: | :-: | :-: | :-: |
| data | object | `{"addr": "", "name": ""}` | The QR code data |
| data.addr | string | `NB7CJOPYUMTOV2XNWOWIDD5SBVPVMMM5HKW4M34S` | The contact account address. |
| data.name | string | `My friend` | The contact name. |
...
| **field** | **type** | **values** | **description** |
| :-: | :-: | :-: | :-: |
| v | integer | `1` | The QR Code version |
| type | integer | `2` | The QR Code type (2 = **ExportAccountQR**) |
| data | object | `{"encryptedKey": "", "salt": ""}` | The QR code data |
| data.encryptedKey | string | `` | 32 bytes IV prepended to 96 bytes of encrypted payload resulting int: `iv || encryptedKey`. |
| data.salt | string | `6c9ba0c43cd75b4f323947273db9b6f95aef95695197c0b24a5e10116e3923d1` | 32 bytes salt that was used for encryption. |
...
```json
{
  ...
  "chain_id": "E2A9F95E129283EF47B92A62FD748DBA4D32AA718AE6F8AC99C105CFA9F27A31",
  "data": {
    "encryptedKey": "",
...
| v | integer | `1` | The QR Code version. |
| type | integer | `2` | The QR Code type (2 = **ExportAccountQR**). |
| data | object | Specific to specialization | The QR code data. |
