...
For **Add Wallet contact** we actually can think of how to use [vCard](https://en.wikipedia.org/wiki/VCard) in our catapult wallet, the advantage of Vcard it can directly save into device contact list. Below is a sample of the vCard params.
```
BEGIN:VCARD
VERSION:4.0
N:Anthony
