...
Downloads the recommended network settings, including the nemesis block configurable definition and peers files.
...
| Option                              | Required | Default                                | Description                         |
|-------------------------------------|----------|----------------------------------------|-------------------------------------|
| ``--resources <resources>``         | Yes      |                                        | URL to resources compressed folder. |
...
Updates the node role by overwritting the resources configuration files.
